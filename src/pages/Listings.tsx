    ...
    <div className="min-h-screen">
      ...
      <main className="py-16">
        <div className="container mx-auto px-4">
          <h1 className="text-4xl font-bold text-gray-900 mb-8">All Listings</h1>
          
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {allListings.map((item) => (
              <Card key={item.id} className="group hover:shadow-lg transition-shadow duration-300">
                <div className={`h-48 ${item.image} rounded-t-lg relative overflow-hidden`}>
                ...
                <CardContent className="p-4">
                  ...
                  <p className="text-2xl font-bold text-orange-500 mb-2">{item.price}</p>
